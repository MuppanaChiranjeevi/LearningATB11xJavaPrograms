...
public class Lab046_ForLoop {
    /**
     *A for loop in Java is used to repeatedly execute a block of code for a specific number of times.
     ...
     *            If it evaluates to true, the code inside the loop gets executed.
